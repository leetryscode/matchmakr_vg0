    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-60 flex justify-center items-center z-50">
            <div className="bg-background-card rounded-lg p-8 w-full max-w-md text-center shadow-xl border border-gray-200">
                <h2 className="text-2xl font-light mb-4 text-primary-blue tracking-[0.05em] uppercase" style={{ fontFamily: "'Bahnschrift Light', 'Bahnschrift', -apple-system, BlinkMacSystemFont, 'Segoe UI', system-ui, sans-serif" }}>END SPONSORSHIP WITH {sponsorName || 'YOUR MATCHMAKR'}?</h2>
        ...
        <>
            <div className="bg-background-card p-6 rounded-lg shadow-card mt-8 text-center border border-gray-200">
                <Link href={`/profile/${sponsor.id}`} className="group">
                    <h2 className="text-2xl font-light mb-4 group-hover:text-primary-blue transition-colors tracking-[0.05em] uppercase" style={{ fontFamily: "'Bahnschrift Light', 'Bahnschrift', -apple-system, BlinkMacSystemFont, 'Segoe UI', system-ui, sans-serif" }}>YOUR MATCHMAKR</h2>
