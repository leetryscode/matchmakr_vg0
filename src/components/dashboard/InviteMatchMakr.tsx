    ...
    return (
        <>
            <div className="orbit-surface p-6 rounded-lg shadow-card mt-8 border border-orbit-border/50">
                ...
                <div className="mt-4 p-4 border border-orbit-border rounded-lg flex items-center justify-between bg-orbit-surface-1">
                    <span className="text-orbit-text2">Chat with the user who manages your profile!</span>
                    <button className="rounded-cta px-4 py-2 min-h-[44px] bg-action-primary text-orbit-canvas font-semibold shadow-cta-entry hover:bg-action-primary-hover active:bg-action-primary-active focus:outline-none focus:ring-2 focus:ring-orbit-gold/30 focus:ring-offset-2 transition-colors duration-200">
                        View Profile
                    </button>
                </div>
                <button
                    onClick={() => setIsModalOpen(true)}
                    className="mt-4 w-full rounded-cta min-h-[48px] bg-action-primary text-orbit-canvas font-semibold shadow-cta-entry hover:bg-action-primary-hover active:bg-action-primary-active focus:outline-none focus:ring-2 focus:ring-orbit-gold/30 focus:ring-offset-2 transition-colors duration-200 py-3"
                >
