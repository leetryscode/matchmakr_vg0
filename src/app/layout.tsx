      ...
      <body className="font-sans min-h-dvh text-orbit-text antialiased leading-normal text-base">
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var t=localStorage.getItem("orbit_theme")||"navy-luxe";if(t!=="navy-luxe"&&t!=="navy-classic"&&t!=="plum-society"&&t!=="invitation-cream"&&t!=="dev-charcoal")t="navy-luxe";document.documentElement.dataset.theme=t;}catch(e){document.documentElement.dataset.theme="navy-luxe";}}());`,
          }}
        />
        <AuthProvider>
          <GlobalLayout>
