    ...
    return (
        <DashboardLayout firstName={firstName} userId={user.id} userType="MATCHMAKR">
            <div className="pt-0 pb-2 px-4">
                <div className="text-2xl text-white font-light mb-1 tracking-[0.05em]" style={{ fontFamily: "'Bahnschrift Light', 'Bahnschrift', -apple-system, BlinkMacSystemFont, 'Segoe UI', system-ui, sans-serif" }}>Hello, {firstName}</div>
            </div>
            <SinglesPondButton />
            ...
            <div className="mt-10 flex flex-col items-center mb-32">
                <h2 className="text-xl text-white mb-4 border-b border-white/20 pb-1 w-full text-center tracking-[0.05em]" style={{ fontFamily: "'Bahnschrift Light', 'Bahnschrift', -apple-system, BlinkMacSystemFont, 'Segoe UI', system-ui, sans-serif" }}>Manage my singles</h2>
